...
정점 u와 정점 v의 가중치 1인 양방향 간선을 나타낸다. (1 ≤ u < v ≤ N, u ≠ v) 모든 간선의 (u, v) 쌍의 값은 서로 다르다.
...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		IntStream.range(0, N).forEach(e -> E.add(new ArrayList<>()));
	...
	static void dfs(int[] V, List<List<Integer>> E, int R) {
		V[R] = cnt;
