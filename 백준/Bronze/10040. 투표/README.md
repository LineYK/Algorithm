...
2025년 9월 10일 09:10:31

### 문제 설명

<p><img alt="" src="" style="float: right; height: auto; width: auto; max-width: 100%;" class="img-responsive">20XX년 도쿄에서 세계적인 스포츠 대회가 열린다. 프로그래밍 대회는 전세계적으로 인기있는 스포츠이고, 정식 종목으로 채택 될 가능성이 점점 높아지고 있다. 정식 종목으로 채택될 경기를 조직위원회에 문의해보니 다음과 같은 답변을 얻게 되었다.</p>
